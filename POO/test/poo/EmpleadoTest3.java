 ...
 * @author usuario
 */
public class EmpleadoTest3 {
    private Persona p;
    private Empleado instance;
    
    public EmpleadoTest3() {
        ...
        //datos caso 1
        instance=new Empleado(p,"45000111B",1000.0,10,5.0,'N',0);
        
        Empleado.setPagoPorHoraExtra(30);
    }
